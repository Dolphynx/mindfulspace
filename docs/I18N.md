...
- Les namespaces déjà utilisés par le projet : `footer`, `navbar`, `publicHome`, `resourcesPage`, `offlinePage`, `cookiesPolicyPage`, `contactPage`, `formationPage`, `breathingSession`, `moodSession`, `sessionRecap`, `tipSession`, `domainSleep`, `domainExercice`, `domainMeditation`, etc.
