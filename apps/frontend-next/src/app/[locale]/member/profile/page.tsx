...
export default function ProfileSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-brandSurface py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <section className="bg-white rounded-xl border border-brandBorder p-6">
          ...
          {!profile.roles.includes("premium") && !profile.roles.includes("coach") && !profile.roles.includes("admin") && (
