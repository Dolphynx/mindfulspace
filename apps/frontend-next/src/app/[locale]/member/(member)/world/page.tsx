 ...
 *
 * @remarks
 * - Décor (dégradé + vagues) fixe en arrière-plan.
 * - Contenu (îlots + panneau) dans une zone scrollable interne sous le header sticky.
 * - Les vagues ne doivent pas intercepter les interactions (`pointer-events-none`).
 */
export default function SerenityLanding() {
    ...
    /**
     * Navigation vers un domaine via les îlots.
     */
    ...
    return (
      ...
      "
        >
            {/* BACKGROUND WAVES (fixes, non interactives) */}
            ...
            {/* SCROLL AREA (seul le contenu bouge) */}
