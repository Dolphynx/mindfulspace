...
/**
 * Tests unitaires du {@link ExerciceSessionController}.
 *
 * @remarks
 ...
 */
describe("ExerciceSessionController", () => {
  /**
  ...
  let controller: ExerciceSessionController;

  beforeEach(() => {
    jest.clearAllMocks();
    controller = new ExerciceSessionController(
